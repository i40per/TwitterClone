...
//  TwitterClone
//
//  Created by Евгений Лукин on 08.06.2023.
//
...
final class AuthentificationViewViewModel: ObservableObject {
    ...
    func validateAuthentificationForm() {
        ...
        isAuthentificationFormValid = isValidEmail(email) && password.count >= 8
    }
